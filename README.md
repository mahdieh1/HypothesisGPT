...
## Description
This repository contains the implementation of the proposed methodology for the paper "GraphCubeExplorer". The methodology consists of three main steps: graph generation, pathway exploration, and diverse query generation. This README file will guide you through the process of understanding and using the codebase.
